        ...
        return (
            <React.Fragment>
                ...
                <Navbar expand= "md" dark sticky="top">
                    <div className="container">
                        <NavbarBrand claasName="mr-auto" href="/"><img src="/assets/images/logo.png" height="30"
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup>
                                ...
                                <Input type="password" id="password" name="password" innerRef={input =>
                                this.password = input} />
                            </FormGroup>
                            <FormGroup check>
                                <Label check>
                                    <Input type="checkbox" name="remember" innerRef={input =>
                                this.remember = input}/>
                                    Remember me
                                </Label>
                            </FormGroup>
